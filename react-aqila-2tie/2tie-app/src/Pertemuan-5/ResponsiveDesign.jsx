  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="bg-gradient-to-r from-blue-400 to-indigo-500 text-white w-full md:w-1/2 p-6 rounded-xl shadow-md">
          Kolom 2
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mt-4">
        <div className="bg-gradient-to-br from-blue-500 to-cyan-400 text-white p-6 rounded-xl shadow-md">
          Box 1
        </div>
        <div className="bg-gradient-to-br from-blue-500 to-cyan-400 text-white p-6 rounded-xl shadow-md">
          Box 2
